...
import com.usewalletkit.sdk.generated.models.UsersLoginWithMagicLinkRequest
...
interface UsersApi {
     ...
     *  - 500: 
     *
     * @param usersLoginWithMagicLinkRequest 
     * @return [LoginWithEmailResponse]
     */
    @POST("users/login-with-email")
    suspend fun usersLoginWithEmail(@Body usersLoginWithMagicLinkRequest: UsersLoginWithMagicLinkRequest): Response<LoginWithEmailResponse>
    ...
    suspend fun usersLoginWithMagicLink(@Body usersLoginWithMagicLinkRequest: UsersLoginWithMagicLinkRequest): Response<SessionChallenge>
